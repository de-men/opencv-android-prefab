...
public:
    ...
    /**
     * @brief Prepare inner kernels states for a new opencv_video-stream.
     *
     * GCompiled objects may be used to process opencv_video streams frame by frame.
     ...
     * In this case, if user starts processing another opencv_video stream with
     * this GCompiled, this method needs to be called to let kernels re-initialize
     * their internal states to a new opencv_video stream.
     */
