...
struct GInferBase {
    static constexpr const char * id() {
        return "org.opencv.opencv_dnn.infer";            // Universal stub
    }
...
struct GInferROIBase {
    static constexpr const char * id() {
        return "org.opencv.opencv_dnn.infer-roi";        // Universal stub
    }
    static GMetaArgs getOutMeta(const GMetaArgs &, const GArgs &) {
        return GMetaArgs{};                       // One more universal stub
    }
...
struct GInferListBase {
    static constexpr const char * id() {
        return "org.opencv.opencv_dnn.infer-roi-list-1"; // Universal stub
    }
    static GMetaArgs getOutMeta(const GMetaArgs &, const GArgs &) {
        return GMetaArgs{};                       // One more universal stub
    }
...
struct GInferList2Base {
    static constexpr const char * id() {
        return "org.opencv.opencv_dnn.infer-roi-list-2"; // Universal stub
    }
    static GMetaArgs getOutMeta(const GMetaArgs &, const GArgs &) {
        return GMetaArgs{};                       // One more universal stub
    }
