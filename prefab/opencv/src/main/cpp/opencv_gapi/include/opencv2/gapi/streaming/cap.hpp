 ...
 * doesn't depend on opencv_videoio module.
 *
 ...
 * application.
 *
 * Note for developers: please don't put opencv_videoio dependency in G-API
 ...
 *
 * Please make sure that opencv_videoio OpenCV module is available before using
...
protected:
    ...
    void prep()
    {
        ...
        // owning the opencv_video buffer under cv::Mat so in order to
