 ...
 * opencv_video-oriented algorithms, like optical flow and background subtraction.
 */
namespace  video
{
...
G_TYPED_KERNEL(GBuildOptFlowPyramid, <GBuildPyrOutput(GMat,Size,GScalar,bool,int,int,bool)>,
               "org.opencv.opencv_video.buildOpticalFlowPyramid")
{
...
G_TYPED_KERNEL(GCalcOptFlowLK,
               ...
               "org.opencv.opencv_video.calcOpticalFlowPyrLK")
{
...
G_TYPED_KERNEL(GCalcOptFlowLKForPyr,
               ...
               "org.opencv.opencv_video.calcOpticalFlowPyrLKForPyr")
{
...
G_TYPED_KERNEL(GBackgroundSubtractor, <GMat(GMat, BackgroundSubtractorParams)>,
               "org.opencv.opencv_video.BackgroundSubtractor")
{
...
G_TYPED_KERNEL(GKalmanFilter, <GMat(GMat, GOpaque<bool>, GMat, KalmanParams)>,
               "org.opencv.opencv_video.KalmanFilter")
{
...
G_TYPED_KERNEL(GKalmanFilterNoControl, <GMat(GMat, GOpaque<bool>, KalmanParams)>, "org.opencv.opencv_video.KalmanFilterNoControl")
{
...
@note Function textual ID is "org.opencv.opencv_video.buildOpticalFlowPyramid"
...
@note Function textual ID is "org.opencv.opencv_video.calcOpticalFlowPyrLK"
...
/**
@overload
@note Function textual ID is "org.opencv.opencv_video.calcOpticalFlowPyrLKForPyr"
*/
GAPI_EXPORTS std::tuple<GArray<Point2f>, GArray<uchar>, GArray<float>>
...
@note Functional textual ID is "org.opencv.opencv_video.BackgroundSubtractor"
...
@note Functional textual ID is "org.opencv.opencv_video.KalmanFilter"
...
@note Function textual ID is "org.opencv.opencv_video.KalmanFilterNoControl"
...
template<> struct CompileArgTag<cv::gapi::video::BackgroundSubtractorParams>
{
    ...
    {
        return "org.opencv.opencv_video.background_substractor_params";
    }
};
}  // namespace detail
}  // namespace cv
